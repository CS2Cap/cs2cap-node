...
export interface GetPriceCandlesRequest {
    ...
    interval?: GetPriceCandlesIntervalEnum;
    fill?: boolean;
    currency?: string;
}
...
export class PricesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getPriceCandles without sending the request
     */
    async getPriceCandlesRequestOpts(requestParameters: GetPriceCandlesRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
     ...
     * Get Price Candles
     */
    async getPriceCandlesRaw(requestParameters: GetPriceCandlesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PriceCandlesPage>> {
        const requestOptions = await this.getPriceCandlesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Get Price Candles
     */
    async getPriceCandles(requestParameters: GetPriceCandlesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PriceCandlesPage> {
     ...
     * Get Price History
     */
    async getPriceHistoryRaw(requestParameters: GetPriceHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PriceSnapshotPage>> {
     ...
     * Get Price History
     */
    async getPriceHistory(requestParameters: GetPriceHistoryRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PriceSnapshotPage> {
 ...
 * @export
 */
export const GetPriceCandlesIntervalEnum = {
    _1d: '1d',
    _1h: '1h',
    _5m: '5m'
} as const;
export type GetPriceCandlesIntervalEnum = typeof GetPriceCandlesIntervalEnum[keyof typeof GetPriceCandlesIntervalEnum];
