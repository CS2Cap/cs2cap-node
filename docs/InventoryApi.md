...
|------------- | ------------- | -------------|
| [**getSteamInventory**](InventoryApi.md#getsteaminventory) | **GET** /v1/inventory/steam | Get Steam Inventory |
| [**getSteamInventoryBySteamId**](InventoryApi.md#getsteaminventorybysteamid) | **GET** /v1/inventory/steam/lookup | Get Steam Inventory by Steam ID |



## getSteamInventory

> SteamInventoryResponse getSteamInventory()
...
import type { GetSteamInventoryRequest } from 'cs2cap';
...
async function example() {
  ...
  try {
    const data = await api.getSteamInventory();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
## getSteamInventoryBySteamId

> SteamInventoryResponse getSteamInventoryBySteamId(steamId)
...
import type { GetSteamInventoryBySteamIdRequest } from 'cs2cap';
...
async function example() {
  ...
  } satisfies GetSteamInventoryBySteamIdRequest;

  try {
    const data = await api.getSteamInventoryBySteamId(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
