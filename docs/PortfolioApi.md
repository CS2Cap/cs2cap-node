...
| [**getPortfolioValue**](PortfolioApi.md#getportfoliovalue) | **GET** /v1/portfolio/{portfolio_id}/value | Get Portfolio Value |
| [**getPortfolioValueHistory**](PortfolioApi.md#getportfoliovaluehistory) | **GET** /v1/portfolio/{portfolio_id}/history | Get Portfolio Value History |
...
| [**valuePortfolio**](PortfolioApi.md#valueportfolio) | **POST** /v1/portfolio/value | Value Portfolio |
...
> PortfolioResponse getPortfolioValue(portfolioId, currency, providers)
...
import type { GetPortfolioValueRequest } from 'cs2cap';
...
async function example() {
  ...
  const body = {
    ...
    providers: ...,
  } satisfies GetPortfolioValueRequest;

  try {
    const data = await api.getPortfolioValue(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> PortfolioHistoryPage getPortfolioValueHistory(portfolioId, startDate, endDate, lookback, currency, providers, limit, cursor, basis)
...
import type { GetPortfolioValueHistoryRequest } from 'cs2cap';
...
async function example() {
  ...
  const body = {
    ...
    basis: basis_example,
  } satisfies GetPortfolioValueHistoryRequest;

  try {
    const data = await api.getPortfolioValueHistory(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> PortfolioResponse valuePortfolio(portfolioRequest)
...
import type { ValuePortfolioRequest } from 'cs2cap';
...
async function example() {
  ...
  const body = {
    // PortfolioRequest
    portfolioRequest: ...,
  } satisfies ValuePortfolioRequest;

  try {
    const data = await api.valuePortfolio(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
